    ...
    <div id="contact" className={styles.contactSection}>
      <div>
        ...
        <p className={styles.contactText}>
          Operating at the intersection of cultural signaling and commercial strategy - where sport, fashion, technology, nightlife and music converge. Available for select consulting engagements, creative direction, and strategic partnerships.
        </p>
